...
## Phase 2 — Yaroslavl discovery crawler
...
## Phase 7 — scale beyond the pilot
...
1. Inspect the latest provider response shapes and existing model boundaries.
2. Draft the database schema and migrations without changing Telegram behavior.
3. Implement fixture-based Yandex category discovery for Yaroslavl.
4. Expose crawl state through a minimal Telegram admin flow.
